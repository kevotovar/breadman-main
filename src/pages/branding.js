    ...
    <Layout>
      <div className="min-h-screen bg-breadman-black pt-24 pb-12 md:pt-64">
        ...
        <div className="flex flex-wrap items-stretch justify-between max-w-6xl mx-auto mt-20">
          <div className="flex flex-col border-2 border-breadman-red rounded-lg w-full md:1/2 lg:w-1/5">
            <div className="flex flex-col items-center flex-1 p-5">
              <h5 className="text-2xl text-breadman-red text-center">Target</h5>
              ...
              <p className="text-white text-center text-sm">
                ...
                <br />
                <br />
                Sabremos cuáles son las necesidades de nuestro Target, sabrémos
                como piensan y conoceremos a nuestra competencia.
              </p>
            </div>
          ...
          <div className="flex flex-col border-2 border-breadman-red rounded-lg w-full md:1/2 lg:w-1/5">
            <div className="flex flex-col items-center flex-1 p-5">
              ...
              <div className="w-6 h-1 bg-breadman-red mt-2 mb-6"></div>
              <p className="text-white text-center text-sm">
                Si tu marca fuera una persona ¿cómo se llamaría? ¿cómo actuaría?
                ¿qué gustos tendría? ¿qué rol jugaría? ¿cómo pensaría?
                <br />
                <br />
          ...
          <div className="flex flex-col border-2 border-breadman-red rounded-lg w-full md:1/2 lg:w-1/5">
            <div className="flex flex-col items-center flex-1 p-5">
              <h5 className="text-2xl text-breadman-red text-center">Voice</h5>
              <div className="w-6 h-1 bg-breadman-red mt-2 mb-6"></div>
              <p className="text-white text-center text-sm">
                ¿Cómo es la voz de tu marca? ¿Es hombre o es mujer? ¿Es firme o
                relajada? ¿Es seria o tiene sentido del humor?
                <br />
                <br />
                Ya que tenemos una personalidad definida le ponemos una voz y un
                tono a nuestra marca con el fin de poder comunicarse con el
                target.
              </p>
            </div>
            <div className="border-t-2 border-breadman-red px-6 pt-4">
